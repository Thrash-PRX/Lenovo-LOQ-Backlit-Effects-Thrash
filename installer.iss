...
DefaultDirName={autopf}\Thrash\Lenovo LOQ Backlit Effects
DefaultGroupName=Lenovo LOQ Backlit Effects - Thrash
DisableProgramGroupPage=yes
LicenseFile=LICENSE
InfoBeforeFile=installer\INSTALL-NOTES.txt
OutputDir=installer-dist
OutputBaseFilename=LenovoLOQBacklitEffects-Thrash-Setup-v{#MyAppVersion}
...
[Files]
Source: "installer-app\LenovoLOQBacklitEffects-Thrash\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
